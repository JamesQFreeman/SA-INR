...
if __name__ == '__main__':
    ...
    a=Get_gradient_loss()
    img_dir="/mnt/shared_storage/wangxin/xuankai/VAE/VAE-Pytorch/T2/SRNii/"
    #img_dir="/mnt/shared_storage/wangxin/skull_stripped/"
    for f in os.listdir(img_dir):
        #path="branch/00f52d59-f1a8969c-63d54808-0c04bed5-d66035fe/1/sr.nii.gz"
        path=os.path.join(img_dir,f,'xr.nii.gz')
